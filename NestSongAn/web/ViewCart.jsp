...
<html>
    ...
    <body>
        ...
        %>
        <h1>Giỏ Hàng Rỗng</h1>
        <a href="HomeController">Thêm Sản Phẩm Vào Giỏ</a>
        <%
        } else {
            if (cart.size() > 0) {
        %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <form action="CartController" method="POST">
                                                        ...
                                                        <td class="align-middle"><strong><fmt:formatNumber type="currency" value="<%=item.getProduct().getPrice()%>"/></strong></td>
                                        ...
                                        <div class="p-4">
                                            ...
                                            <form action="CartController?op=checkout&id=0" method="POST" >
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea row="" cols="" name="address" class="form-control" required></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                        ...
                                        <div class="p-4">
                                            <ul class="list-unstyled mb-4">
                                                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng tiền hàng</strong><strong>
                                                        <fmt:formatNumber type="currency" value="${Integer(sessionScope.total)}"/>
                                                    </strong></li>
                                                ...
                                                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">VAT</strong><strong><fmt:formatNumber type="currency" value="${sessionScope.total*10/100} " /></strong></li>
                                                <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">Tổng thanh toán</strong>
                                                    <h5 class="font-weight-bold">  <fmt:formatNumber type="currency" value="${sessionScope.total+sessionScope.total*10/100}" /></h5>
                                                </li>
