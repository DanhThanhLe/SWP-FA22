...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="ManagerController">Trang Chủ</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="ManageProductController">Quản Lí Sản Phẩm</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="ViewReport.jsp">Thống Kê</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="OrderViewController?op=view_Order">Xem Đơn Hàng</a>
                            </li>
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="jumbotron-heading">Tổ Yến Song Ân</h1>
            ...
            <div class="row">
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="ManagerController">Trang Chủ</a></li>
