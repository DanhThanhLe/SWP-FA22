<%-- 
    Document   : theongay
    Created on : Nov 13, 2022, 6:11:56 PM
    Author     : minhd
--%>
	...
	<div class="container">
        <div class="row">
         ...
         <div class="row">
            <div class="col-sm-3">
                <h1>Mời chọn ngày:</h1>
                <form action="ReportController?action=TheoNgay" method="post">
				    ...
				    <div class="modal-dialog">
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				        	<jsp:include page="BieuDo/bieudodoanhthusanphamtheongay.jsp"></jsp:include>
				        </div>
